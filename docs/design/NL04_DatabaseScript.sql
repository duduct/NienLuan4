/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     8/30/2014 10:18:14 PM                        */
/*==============================================================*/
...
create table KHAC
(
   KHACID               int not null auto_increment,
...
alter table DIACHI add constraint FK_CT_DUONG foreign key (DUONGID)
      references DUONG (DUONGID) on delete restrict on update restrict;

alter table DIACHI add constraint FK_CT_KHAC foreign key (KHACID)
      references KHAC (KHACID) on delete restrict on update restrict;

alter table DIACHI add constraint FK_CT_PHUONG foreign key (PHUONGID)
